...
CREATE TABLE `inventory` (
  ...
  KEY `itemID` (`itemID`),
  CONSTRAINT `inventory_ibfk_1` FOREIGN KEY (`itemID`) REFERENCES `masteritem` (`itemID`) ON UPDATE CASCADE
...
INSERT INTO `inventory` VALUES (2,'I11000',50,'loc1'),(5,'c-19',100,'Loc-2');
